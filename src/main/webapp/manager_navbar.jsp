            ...
            <ul class="nav navbar-nav">
                <c:choose>
                    ...
                    <c:when test="${selectedTab eq 'pending'}">
                        <li class="active"><a href="/ers/pending.do">New Requests
                            <span class="badge">
                                <c:out value="${reimbursements.size()}"></c:out>
                            </span>
                        </a></li>
                    ...
                    <c:when test="${selectedTab eq 'approved'}">
                        ...
                        <li class="active"><a href="/ers/approved.do">Approved
                            <span class="badge">
                                <c:out value="${reimbursements.size()}"></c:out>
                            </span>
                        </a></li>
                    ...
                    <c:when test="${selectedTab eq 'declined'}">
                        <li><a href="/ers/pending.do">New Requests</a></li>
                        <li><a href="/ers/approved.do">Approved</a></li>
                        <li class="active"><a href="/ers/declined.do">Declined
                            <span class="badge">
                                <c:out value="${reimbursements.size()}"></c:out>
                            </span>
                        </a></li>
